...
description: Fresh-context design document evaluator. Reads only the design doc and codebase, reports ambiguities and blocking gaps. No conversation context inherited. Saves results to docs/audits/.
...
Derive the filename from the design doc path: `docs/adr-0007-github-oauth.md` → `docs/audits/design-github-oauth-<YYYY-MM-DD>.md`

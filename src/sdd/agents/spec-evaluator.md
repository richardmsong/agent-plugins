---
name: spec-evaluator
description: Fresh-context spec alignment evaluator. Reads an ADR and all referenced specs, reports every gap where the ADR decides X but the spec doesn't reflect X. No conversation context inherited. Saves results to docs/audits/.
